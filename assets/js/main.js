...
// JavaScript for Red Loading State
    ...
    effectBtns.forEach(function(btn) {
        ...
        btn.addEventListener('click', function(e) {
            ...
            if(currentActive && currentActive !== btn) {
                currentActive.classList.remove('active-effect');
                currentActive.querySelectorAll('span').forEach(span => {
            ...
            }, 900); // Match transition duration (300ms = 0.3s)
...
document.addEventListener('DOMContentLoaded', function() {
    let effectBtns = document.querySelectorAll('.effect-btn');
